...
- 首页：`https://zhuayuba.github.io/career-lab/`
- 第 N 期：`https://zhuayuba.github.io/career-lab/NN.html`（如 `01.html`）

## 代码仓库

- GitHub：`zhuayuba/career-lab`
- 本地路径：`/Users/linxiao/Desktop/project/data_radar/career-series/`
